...
function writerList(bb) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/loginnick',
		type : 'GET',
		dataType:'json',
		data:{bb,limit},
		success : function (data) {
			...
			for(var i=0; i<data.length; i++){
			    ...
			    html+='</div>'
			    html+='</header>';
			    html+='<div class="photo_body"><img src="http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/upload/'+data[i].guest_photo+'"></div>';
...
$.ajax({
		...
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/cmt',
		type : 'Post',
		dataType:'json', 
		data : {
...
function deleteForm(a,b) {
	...
	let obj={"guest_idx":a,"guest_photo":b};
	
	if(confirm('정말 삭제하시겠습니까?')){
		$.ajax({
			
			url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/deletec',
			type : 'DELETE',
			dataType:'json',
...
function guestPost() {
	...
	$.ajax({
		url : 'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/post',
		type : 'post',
...
/////////////////////수정 팝업펑션
  function editService() {
	...
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/edi' ,
		type:'POST',
		processData : false, // File 전송시 필수 
		contentType : false, // multipart/form-data 쓰는 코드
		data : editFormData,
...
function editPopup(guest_idx) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/'+guest_idx ,
		type:'GET',
		data : {nick:bb},
		success : function (data) {
...
function cmtedit(comment_idx,guest_idx) {
	...
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/cmt/'+comment_idx ,
		type:'GET',
		success : function (data) {
			var html='';
...
function editCmtText() {
	...
	let obj={"cmtedittext":cmtedittext,"cmteditidx":cmteditidx}
	
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/cmtedit',
		type:'PUT',
		dataType:'json',
		data : JSON.stringify(obj),
		contentType:'application/json; charset=utf-8',
...
function deleteCmt(comment_idx,guest_idx) {
	...
	if(confirm('정말 삭제하시겠습니까?')){
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/delcmt/'+comment_idx,
		type:'DELETE',
		success : function (data) {
		...
		success : function (data) {
			...
			if(data.guest_photo !=null){
				html+='<article class="in_wrap">'
					html+='<div class="flex">'
						html+='<div class="in_photo"><img src="http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/upload/'+data.guest_photo+'"></div>'
...
function gbList() {
	...
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book' ,
		dataType:'json',
		type:'get',
		traditional : true,
		 data : {
...
async function total() {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/test',
		type:'GET',
		contentType: 'application/json; charset=utf-8',
		data : {
			 x :x,
...
function likeup2(guest_idx) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/plus/'+guest_idx,
		type:'POST',
		data :  
			 bb ,
		contentType: 'application/json; charset=utf-8',
...
function likedown2(guest_idx) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/mi/'+guest_idx,
		type:'DELETE',
		data:bb,
		contentType: 'application/json; charset=utf-8',
		success : function (data) {
...
function likeupcount(guest_idx) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/pluscount/'+guest_idx,
		type:'PUT',
		contentType: 'application/json; charset=utf-8',
		success : function (data) {
			gbList();
...
function likedowncount(guest_idx) {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/micount/'+guest_idx,
		type:'PUT',
		contentType: 'application/json; charset=utf-8',
		success : function (data) {
			gbList();
...
function hitsup(guest_idx) {
		...
		$.cookie('cookie',newcookies, { expires: 30 / 1440, path: '/' });
		 ...
		 $.ajax({
				url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/hitsup/'+guest_idx,
				type:'PUT',
				contentType: 'application/json; charset=utf-8',
				success : function (data) {
				}
...
function counttest() {
	$.ajax({
		url:'http://ec2-3-35-168-195.ap-northeast-2.compute.amazonaws.com:8080/guest/guest_book/mycount/',
		type:'GET',
		contentType: 'application/json; charset=utf-8',
		data:{bb},
		success : function (data) {
