...
<body>
  ...
  <div class="w3-top">
    ...
    <div class="w3-bar w3-white w3-card" id="myNavbar">
      ...
      <a href="<c:url value="/member/memberReg"/>" class="w3-bar-item w3-button">회원가입</a>
        <a href="<c:url value="/member/memberLogin"/>" class="w3-bar-item w3-button">로그인</a>
  ...
  <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large"
    ...
    <a href="<c:url value="/member/memberReg"/>" onclick="w3_close()" class="w3-bar-item w3-button">회원가입</a>
    <a href="<c:url value="/member/memberLogin"/>" onclick="w3_close()" class="w3-bar-item w3-button">로그인</a>
    <a href="<c:url value="/member/memberMypage/mypageForm"/>" onclick="w3_close()" class="w3-bar-item w3-button">마이페이지</a>
